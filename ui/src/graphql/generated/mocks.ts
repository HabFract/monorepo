  ...
  return {
    ...
    orbits:
      overrides && overrides.hasOwnProperty("orbits")
        ...
        : anOrbitConnection(),
    getOrbitHierarchy:
      overrides && overrides.hasOwnProperty("getOrbitHierarchy")
        ? overrides.getOrbitHierarchy!
        : "sint",
    getLowestSphereHierarchyLevel:
      overrides && overrides.hasOwnProperty("getLowestSphereHierarchyLevel")
        ? overrides.getLowestSphereHierarchyLevel!
        : 7407,
    me:
  ...
  return {
    createSphere:
      overrides && overrides.hasOwnProperty("createSphere")
        ...
        : aCreateSphereResponsePayload(),
    updateSphere:
      overrides && overrides.hasOwnProperty("updateSphere")
        ? overrides.updateSphere!
        : aCreateSphereResponsePayload(),
    deleteSphere:
      overrides && overrides.hasOwnProperty("deleteSphere")
        ? overrides.deleteSphere!
        : "d656573f-6b5f-48b1-b767-997e497a6673",
    createOrbit:
      overrides && overrides.hasOwnProperty("createOrbit")
        ? overrides.createOrbit!
        : aCreateOrbitResponsePayload(),
    updateOrbit:
      overrides && overrides.hasOwnProperty("updateOrbit")
        ? overrides.updateOrbit!
        : aCreateOrbitResponsePayload(),
    deleteOrbit:
      overrides && overrides.hasOwnProperty("deleteOrbit")
        ? overrides.deleteOrbit!
        : "8c4ff9e4-b0db-409d-ba41-9a0a173bfe93",
    createProfile:
...
export const aCreateSphereResponsePayload = (
  overrides?: Partial<CreateSphereResponsePayload>,
): CreateSphereResponsePayload => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "f1b184fb-8b2c-4441-9415-a6ca7686126d",
    actionHash:
      overrides && overrides.hasOwnProperty("actionHash")
        ? overrides.actionHash!
        : "dicta",
    entryHash:
...
export const aCreateOrbitResponsePayload = (
  overrides?: Partial<CreateOrbitResponsePayload>,
): CreateOrbitResponsePayload => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "5fad755e-8006-4c20-aba3-dd74eea04921",
    actionHash:
      overrides && overrides.hasOwnProperty("actionHash")
        ? overrides.actionHash!
        : "porro",
...
export const aCreateResponsePayload = (
  overrides?: Partial<CreateResponsePayload>,
...
export const aSphere = (overrides?: Partial<Sphere>): Sphere => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "14830037-c822-4498-8463-d3354c2fce66",
...
export const aSphereCreateParams = (
  overrides?: Partial<SphereCreateParams>,
): SphereCreateParams => {
  return {
    name:
...
export const aSphereUpdateParams = (
  overrides?: Partial<SphereUpdateParams>,
): SphereUpdateParams => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "f8706fe3-f5f1-4881-888f-50f3cf5a30a7",
    name:
...
export const anOrbitConnection = (
...
export const anOrbit = (overrides?: Partial<Orbit>): Orbit => {
  return {
    ...
    eH:
      overrides && overrides.hasOwnProperty("eH")
        ? overrides.eH!
        : "exercitationem",
    name:
      overrides && overrides.hasOwnProperty("name")
...
export const anOrbitCreateParams = (
  overrides?: Partial<OrbitCreateParams>,
): OrbitCreateParams => {
  return {
    name:
...
export const anOrbitUpdateParams = (
  overrides?: Partial<OrbitUpdateParams>,
): OrbitUpdateParams => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "5e9990e6-4406-4794-b94d-f5a055814d5c",
    name:
...
export const anOrbitHierarchyQueryParams = (
  overrides?: Partial<OrbitHierarchyQueryParams>,
): OrbitHierarchyQueryParams => {
  return {
    orbitEntryHashB64:
      overrides && overrides.hasOwnProperty("orbitEntryHashB64")
        ? overrides.orbitEntryHashB64!
        : "aut",
    levelQuery:
      overrides && overrides.hasOwnProperty("levelQuery")
        ? overrides.levelQuery!
        : aQueryParamsLevel(),
  };
};

export const aQueryParamsLevel = (
  overrides?: Partial<QueryParamsLevel>,
): QueryParamsLevel => {
  return {
    sphereHashB64:
      overrides && overrides.hasOwnProperty("sphereHashB64")
        ? overrides.sphereHashB64!
        : "cum",
    orbitLevel:
      overrides && overrides.hasOwnProperty("orbitLevel")
        ? overrides.orbitLevel!
        : 9.99,
  };
};
