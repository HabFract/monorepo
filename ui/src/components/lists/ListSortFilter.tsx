    ...
    <div className="list-sort-filter">
      ...
      {isModalOpen && (
        <Modal show={isModalOpen} onClose={toggleModal}>
          <Modal.Header>Sort Criteria</Modal.Header>
          <Modal.Body>
            <Formik
              initialValues={{
                      ...
                      <div className="flex flex-col">
                        <label className="text-xl lowercase capitalize">
                          <Field
                            ...
                            onChange={(e: any) =>
                              store.set(listSortFilterAtom, {
                                ...listSortFilter,
                                sortCriteria: e.currentTarget.value,
                              })
                            }
                            checked={
                              listSortFilter.sortCriteria == SortCriteria.Name
                            }
                            type="radio"
                            name="sortCriteria"
                        ...
                        <label className="text-xl lowercase capitalize">
                          <Field
                            ...
                            checked={
                              listSortFilter.sortCriteria == SortCriteria.Scale
                            }
                            type="radio"
                            name="sortCriteria"
                            value={SortCriteria.Scale}
                            as={Radio}
                          />
                          Scale
                        </label>
