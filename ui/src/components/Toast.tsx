...
const Toast: React.FC = () => {
  ...
  return (
    <div className="toast flex m-2 p-2 gap-2 fixed top-2 right-2 left-2 w-full z-100 rounded-xl bg-menu-bg" style={{zIndex: 200, maxWidth: '24rem'}}>
      ...
      <button onClick={hideToast} className="toast-close text-3xl mr-4 hover:text-primary">
        &times;
      </button>
    </div>
  );
