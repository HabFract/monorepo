...
const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <FBButton
      disabled={
        loading ||
        (!(typeof errors == "undefined" || typeof touched == "undefined") &&
    ...
    >
      {loading ? (
        <div role="status">
          <svg
            aria-hidden="true"
            className="text-center inline w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-gray-600 dark:fill-gray-300"
            viewBox="0 0 100 101"
            fill="none"
