    ...
    <>
      <div className={disabled ? "current-calendar-context-container" : "disabled current-calendar-context-container"}>
        <button className="date-nav-button" onClick={handlePreviousDay}>
          <svg stroke="white" className="date-nav-icon w-8 h-8 ml-1" width="24" height="24" viewBox="0 0 24 24" fill="rgba(255,255,255,0.5)" strokeWidth={0} xmlns="http://www.w3.org/2000/svg">
        ...
        >
          <svg stroke="white" className="date-nav-icon w-8 h-8 mr-1" width="24" height="24" viewBox="0 0 24 24" fill="rgba(255,255,255,0.5)" strokeWidth={0} xmlns="http://www.w3.org/2000/svg">
