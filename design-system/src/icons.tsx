...
export function getIconForPlanetValue(scale: Scale) : FC<ComponentProps<'svg'>> | undefined {
  switch (scale) {
    case Scale.Astro:
      return () => <img style={{height: "24px", width: "24px"}} src="../assets/astro-incomplete.svg" />;
    case Scale.Atom:
      return () => <img style={{height: "24px", width: "24px", marginBottom: "5px"}} src="../assets/atom-incomplete.svg" />;
    case Scale.Sub:
      return () => <img style={{height: "24px", width: "24px", marginBottom: "3px"}} src="../assets/sub-astro-incomplete.svg" />;
  }
}
